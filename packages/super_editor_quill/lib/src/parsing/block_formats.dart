...
class AlignDeltaFormat extends FilterByNameBlockDeltaFormat {
  ...
  List<EditRequest>? applyTo(Operation operation, Editor editor) {
    if (!operation.hasAttribute(name) || operation.hasAttribute(_list)) {
      return null;
    }
...
/// A [BlockDeltaFormat] that applies an alignment to a list item.
class AlignListItemDeltaFormat extends FilterByNameBlockDeltaFormat {
  static const _align = "align";
  static const _alignLeft = "left";
  static const _alignCenter = "center";
  static const _alignRight = "right";
  ...
  const AlignListItemDeltaFormat() : super(_align);
